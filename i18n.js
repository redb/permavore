...
const I18N = {
  ...
  // Panneau réglages
  "champ.ville.label": { fr: "📍 Ta ville", en: "📍 Your town" },
  "champ.ville.placeholder": { fr: "Ex. Rumilly, Nantes, Lyon…", en: "E.g. Boston, Austin, Seattle…" },
  "champ.surface.label": { fr: "📐 Surface du jardin (m²)", en: "📐 Garden size (m²)" },
  "champ.surface.placeholder": { fr: "Ex. 20", en: "E.g. 20" },
  "champ.zone.label": { fr: "🌍 Climat", en: "🌍 Climate" },
  "btn.geo": { fr: "📡 Me localiser", en: "📡 Locate me" },
  "btn.geo.title": { fr: "Me localiser", en: "Locate me" },
  "btn.go": { fr: "Voir", en: "Show" },
  "zone.note.defaut": { fr: "Climat de référence. Ajuste-le si besoin.", en: "Reference climate. Adjust it if needed." },

  // Barre d'outils
  "recherche.placeholder": { fr: "🔍 Rechercher une plante (tomate, basilic, figuier…)", en: "🔍 Search for a plant (tomato, basil, fig tree…)" },
  ...
  "now.sous": { fr: "Nous sommes le {date} : c'est le bon moment pour semer ou planter ces variétés dans ta zone.",
    en: "Today is {date}: it's the right time to sow or plant these varieties in your zone." },

  "soon.titre": { fr: "Bientôt (le mois prochain)", en: "Coming soon (next month)" },

  "autres.titre": { fr: "Autres variétés adaptées", en: "Other suitable varieties" },
  ...
  "vide.defaut": { fr: "Aucune variété ne correspond à ces filtres.", en: "No variety matches these filters." },
  ...
  "total.count": { fr: "{n} variété adaptée", en: "{n} suitable variety" },
  "total.count.pl": { fr: "{n} variétés adaptées", en: "{n} suitable varieties" },
  ...
  "carte.plante": { fr: "✓ Planté", en: "✓ Planted" },
  "carte.adopter": { fr: "＋ Adopter", en: "＋ Add to my garden" },
  ...
  "geo.refusee": { fr: "Localisation refusée. Saisis ta ville ou choisis le climat.", en: "Location access denied. Enter your town or choose the climate." },
